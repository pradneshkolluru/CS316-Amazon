    ...
    with open('db/generated/Users.csv', 'w') as f:
        ...
        for uid in range(num_users):
            if uid == 0:
                ...
                writer.writerow(["1","dawg@data.com","pbkdf2:sha256:260000$1GvmeoAkcWb89TyU$5f711eafb243c1c1a884715dd9bd6d185f29ccd3dab59ad19cc201a7260091cb","Data","Dawg","420 Chapel Dr", "2000"])
            else:
                if uid % 10 == 0:
...
def gen_sellers(num_sellers):
    ...
    with open('db/generated/Sellers.csv', 'w') as f:
        ...
        if 1 not in sellers:
            writer.writerow([1])
            print(f'{num_sellers + 1} generated')
        else:
    ...
    with open('db/generated/Products.csv', 'w') as f:
        ...
        for pid in available_pids:
            ...
            for sid in seller_pid[pid]: # for each seller that sells current pid
                ...
                writer.writerow([id, pid, sid, name, category, description, price, available, image_path])
